...
# Add target alias
.PHONY: nevdev
nevdev: $(builddir)/nevdev.node

# Copy this to the executable output path.
$(builddir)/nevdev.node: TOOLSET := $(TOOLSET)
$(builddir)/nevdev.node: $(obj).target/nevdev.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/nevdev.node
# Short alias for building this executable.
.PHONY: nevdev.node
nevdev.node: $(obj).target/nevdev.node $(builddir)/nevdev.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/nevdev.node
